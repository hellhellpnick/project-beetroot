<template>
  <div class="about-main">
    ...
    <p class="about-main__text">
      ...
      I am a junior Front-End developer. In addition to the front-end, I am interested in everything related to PC, web technologies and video games. At the expense of the gameplay of many games, it is only obscene. In my free time I study new technologies, additional reality VR (Virtual Realite). I recently saw
      <a
        class="about-main__link"
        href="https://threejs.org/"
      >Three.js</a>, this world of animation got me interested. I want to defeat him. Do not mind trying "Eight360 Nova" and the desire to practice in "Spase X" is present, but for now, the augmented reality designer is not against river in the near future.
    ...
    <ul class="list-main">
      ...
      <li class="list-main__item">
        <a class="list-main__item-link" href="https://gulpjs.com/">
          <img
